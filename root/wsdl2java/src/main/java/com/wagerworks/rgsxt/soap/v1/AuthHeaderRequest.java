 ...
 *         &lt;element name="Customer" type="{http://www.wagerworks.com/rgsXT/soap/v1/}AuthCustomerRequest"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlSeeAlso({
    com.wagerworks.rgsxt.soap.v6.AuthHeaderRequest.class
})
public class AuthHeaderRequest {
    ...
    protected AuthCustomerRequest customer;
     ...
     * @return
     *     possible object is
     *     {@link AuthCustomerRequest }
     *     
     */
    public AuthCustomerRequest getCustomer() {
        return customer;
    }
     ...
     *     
     */
    public void setCustomer(AuthCustomerRequest value) {
        this.customer = value;
    }
